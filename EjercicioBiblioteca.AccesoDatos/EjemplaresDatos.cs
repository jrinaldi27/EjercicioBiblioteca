...
namespace EjercicioBiblioteca
{
    public class EjemplaresDatos
    {
        ...
        public List<Ejemplar> Traer(string id)
        {
            string json2 = WebHelper.Get("Biblioteca/Ejemplares/" + id.ToString());
            List<Ejemplar> resultado = Maplist(json2);
            return resultado;
        }
        ...
        public TransactionResult InsertarEjemplar(Ejemplar ejemplar)
        {
            ...
            string json = WebHelper.Post("Biblioteca/Ejemplares", ejemplarDatos);
